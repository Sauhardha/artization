  ...
  return (
   ...
   <div className="text-white">
    ...
    <div className='flex justify-center items-center'>
      <p className="md:text-5xl sm:text-4xl text-xl font-bold py-4"> Fast, flexible service for  </p>
    ...
    <p className='md:text-2xl text-xl font-bold text-gray-500'>Monitor your artwork's emotional analytics to understad your customer's interests better</p>
